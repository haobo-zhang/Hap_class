...
![image-20241120155805127](./photo/image-20241120155805127.png)

基因型分型结果

![image-20241130150011762](./photo/image-20241130150011762.png)

plot_k文件（该文件定义来帮助我们确定k值）

![image-20241130150137302](./photo/image-20241130150137302.png)

tre文件（确定材料间亲缘关系，在层次聚类中才有，相似比对法中不存在）

![image-20241130150253635](./photo/image-20241130150253635.png)

热图绘制文件（为之后自定义绘图准备）

![image-20241130150342904](./photo/image-20241130150342904.png)
